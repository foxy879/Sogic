...
public class ModBlocks {
    ...
    public static final RegistryObject <Block> aaso = registerBlock("block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(4f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST)));
